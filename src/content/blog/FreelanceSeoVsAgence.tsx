...
const FreelanceSeoVsAgence = () => (
  <div className="article-prose space-y-6">
    ...
    <h2 className="text-xl md:text-2xl font-bold mt-12 mb-4">Les tarifs en Suisse romande : ce qu'il faut savoir</h2>
    <p className="text-muted-foreground leading-relaxed">
    ...
    <p className="text-muted-foreground leading-relaxed">
      ...
      <Link to="/services/audit-seo" className="text-primary hover:text-primary/80 underline underline-offset-4 transition-colors">audit SEO</Link>{" "}
      est à CHF 1'200 forfaitaire. L'{" "}
      <Link to="/services/accompagnement-seo" className="text-primary hover:text-primary/80 underline underline-offset-4 transition-colors">accompagnement SEO mensuel</Link>{" "}
      démarre à CHF 250/mois. La{" "}
      <Link to="/services/creation-site-web" className="text-primary hover:text-primary/80 underline underline-offset-4 transition-colors">création de site web</Link>{" "}
      commence à CHF 3'900. Pas de frais cachés, pas de tarif horaire imprédictible.
    </p>

    <h2 className="text-xl md:text-2xl font-bold mt-12 mb-4">Les questions à poser avant de choisir</h2>
    <p className="text-muted-foreground leading-relaxed">
    ...
    <h2 className="text-xl md:text-2xl font-bold mt-12 mb-4">L'approche KUMO : expertise technique et agilité d'un indépendant</h2>
    <p className="text-muted-foreground leading-relaxed">
    ...
    <p className="text-muted-foreground leading-relaxed">
      ...
      <Link to="/blog/site-invisible-google-pme-suisse" className="text-primary hover:text-primary/80 underline underline-offset-4 transition-colors">site invisible sur Google peut être corrigé</Link>, ou pour comprendre{" "}
      <Link to="/blog/audit-seo-pourquoi-indispensable" className="text-primary hover:text-primary/80 underline underline-offset-4 transition-colors">pourquoi un audit SEO est la première étape</Link>, consultez nos articles dédiés.
    </p>
