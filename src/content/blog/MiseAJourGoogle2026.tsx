...
const MiseAJourGoogle2026 = () => (
  <>
    ...
    <ArticleSection number="01" title="Ce que cette mise à jour cible précisément">
      <div className="space-y-5 article-prose">
        ...
        <Marginalia label="DÉFINITION">
          Core update : réévaluation globale de la qualité du contenu. Spam update : sanction ciblée des pratiques trompeuses. Deux logiques distinctes.
        </Marginalia>
        <p className="text-muted-foreground leading-relaxed">
    ...
    <ArticleSection number="02" title="Les trois profils de sites les plus exposés">
      <div className="space-y-5 article-prose">
        <p className="text-muted-foreground leading-relaxed">
    ...
    <PullQuote>
      Le risque n'est plus une simple perte de positions. C'est la désindexation complète du site.
    </PullQuote>

    <ArticleSection number="03" title="Comment vérifier si votre site est touché">
      <div className="space-y-5 article-prose">
        <p className="text-muted-foreground leading-relaxed">
          Avant de paniquer, vérifiez les données. La réaction émotionnelle est l'ennemi du bon diagnostic.
        </p>
        <Marginalia label="REPÈRE">
          Chute de plus de 30 % des impressions ou clics dans Google Search Console la semaine du 24 mars : signal d'alerte.
        </Marginalia>
        <p className="text-muted-foreground leading-relaxed">
    ...
    <ArticleSection number="04" title="Ce que les PME suisses doivent faire maintenant">
      <div className="space-y-5 article-prose">
        <p className="text-muted-foreground leading-relaxed">
    ...
    <ArticleSection number="05" title="Ce que cette mise à jour révèle sur l'évolution du SEO">
      <div className="space-y-5 article-prose">
        <p className="text-muted-foreground leading-relaxed">
